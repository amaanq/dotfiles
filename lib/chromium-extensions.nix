# Chromium extension definitions
# updateUrl is for self-hosted extensions (not on Chrome Web Store)
{
  adnauseam = {
  ...
  control-panel-twitter = {
    id = "mijcgjehgneckmejljjmbfcfkfmjdmlb";
    updateUrl = "https://github.com/amaanq/control-panel-for-twitter/releases/latest/download/updates.xml";
  };
  vencord = {
  ...
  csfloat.id = "jjicbefpemnphinccgikpdaagjebbnhg";
